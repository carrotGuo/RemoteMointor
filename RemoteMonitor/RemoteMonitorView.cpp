...
// RemoteMonitorView.cpp : CRemoteMonitorView 类的实现
//
...
CRemoteMonitorDoc* CRemoteMonitorView::GetDocument() const // 非调试版本是内联的
{
